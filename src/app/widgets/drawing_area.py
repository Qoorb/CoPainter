...
from ..constants import DrawingConstants
...
class DrawingArea(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._init_ui()
        self.setMinimumSize(300, 300)  # Минимальный размер
    ...
    def paintEvent(self, event):
        ...
        # Рисуем текст "Начните творить!"
        if self.clear_screen:
            painter.setPen(QColor("grey"))
            font = painter.font()
            font.setPointSize(24)
            painter.setFont(font)
            painter.drawText(self.rect(), Qt.AlignmentFlag.AlignCenter, "Начните творить!")
    ...
    def resizeEvent(self, event):
        ...
        # Копируем старое изображение на новое с масштабированием
